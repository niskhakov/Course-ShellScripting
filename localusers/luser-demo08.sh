...
# Redirect STDIN to a program, using FD 0 (File descriptor)
read LINE 0< ${FILE}
echo
echo "LINE contains: ${LINE}"
...
head -n3 /etc/passwd /fakefile 2> ${ERR_FILE} # See /tmp/data.err
...
# Redirect STDOUT and STDERR through the pipe
